...
if (!surface_exists(surf)) surf = surface_create(21, 24);

surface_set_target(surf);
draw_clear_alpha(c_black, 0);

ir = irandom_range(0, 42); jr = irandom_range(0, 39);
draw_sprite_part_ext(sprBoss04_65, current_time, ir, jr, 21, 24, 0, 0, 1, 1, c_white, 1);
