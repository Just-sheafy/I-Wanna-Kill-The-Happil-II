if (asdf <= 0 and sprite_index != sprBoss02_10 and image_angle == !other.Gravity*180 and
    collision_rectangle(x-13*image_xscale, y-34*(90-image_angle)/90, x+13*image_xscale, y-23*(90-image_angle)/90, player, 1, 1)) {
    ...
    if (Boss04_1.shell_count >= 8) {
        audio_play_sound(snd04_29, 0, false, world.sound_vol);
    ...
    if (asdf <= 0 and collision_rectangle(x-13*image_xscale, y-34*(90-image_angle)/90, x+13*image_xscale, y, player, 1, 1)) { with(other) kill_player(); }
}