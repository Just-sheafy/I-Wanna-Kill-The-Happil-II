...
if (t >= 0 && t < 1) {
    t = min(1, t+0.01*sp);
    if (bezier) {
        x = (1-t) * ((1-t) * x_before + t * Boss04_36.x) + t * ((1-t) * Boss04_36.x + t * x_after);
        y = (1-t) * ((1-t) * y_before + t * Boss04_36.y) + t * ((1-t) * Boss04_36.y + t * y_after);
    } else {
    ...
    if (instance_exists(player)) {
		temp = instance_create_depth(xx, yy, -50, surf_ripple);
