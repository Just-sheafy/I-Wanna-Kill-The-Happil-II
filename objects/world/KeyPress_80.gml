...
if (room != initRoom and room != beforeRoom and room != startRoom and room != loadRoom and room != beginning and
    ...
    (instance_exists(SavePoint2) or (room != Stage01Bs and room != Stage02Bs and room != Stage03Bs and
		room != Stage04Bs and room != Stage01Sr and room != Stage02Sr and room != Stage03Sr))) {
